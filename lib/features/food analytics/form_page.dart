...
class FoodAnalyticsFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const FoodAnalyticsFormPage({super.key, this.initialData});

  @override
  State<FoodAnalyticsFormPage> createState() => _FoodAnalyticsFormPageState();
}

class _FoodAnalyticsFormPageState extends State<FoodAnalyticsFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create FoodAnalytics' : 'Edit FoodAnalytics'),
        actions: [
          TextButton(
