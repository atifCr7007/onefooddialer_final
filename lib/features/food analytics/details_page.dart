...
class FoodAnalyticsDetailsPage extends ConsumerWidget {
  final Object id;
  const FoodAnalyticsDetailsPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncData = ref.watch(foodanalyticsGetProvider(id));
