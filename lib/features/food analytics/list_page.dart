...
class FoodAnalyticsListPage extends ConsumerStatefulWidget {
  const FoodAnalyticsListPage({super.key});

  @override
  ConsumerState<FoodAnalyticsListPage> createState() => _FoodAnalyticsListPageState();
}

class _FoodAnalyticsListPageState extends ConsumerState<FoodAnalyticsListPage> {
  int page = 1;
  int perPage = 10;
  String q = '';
  final selected = <int>{};
  ...
  Widget build(BuildContext context) {
    ...
    final asyncData = ref.watch(foodanalyticsListProvider(params));
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Search Food Analytics...',
