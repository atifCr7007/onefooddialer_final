...
class StatisticsListPage extends ConsumerStatefulWidget {
  const StatisticsListPage({super.key});

  @override
  ConsumerState<StatisticsListPage> createState() => _StatisticsListPageState();
}

class _StatisticsListPageState extends ConsumerState<StatisticsListPage> {
  int page = 1;
  int perPage = 10;
  String q = '';
  final selected = <int>{};
  ...
  Widget build(BuildContext context) {
    ...
    final asyncData = ref.watch(statisticsListProvider(params));
