...
class KitchenMastersDetailsPage extends ConsumerWidget {
  final Object id;
  const KitchenMastersDetailsPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncData = ref.watch(kitchenMastersGetProvider(id as int));
