...
class SubscriptionPlansFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const SubscriptionPlansFormPage({super.key, this.initialData});

  @override
  State<SubscriptionPlansFormPage> createState() => _SubscriptionPlansFormPageState();
}

class _SubscriptionPlansFormPageState extends State<SubscriptionPlansFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create SubscriptionPlans' : 'Edit SubscriptionPlans'),
        actions: [
          TextButton(
