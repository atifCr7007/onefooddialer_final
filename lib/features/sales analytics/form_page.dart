...
class SalesAnalyticsFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const SalesAnalyticsFormPage({super.key, this.initialData});

  @override
  State<SalesAnalyticsFormPage> createState() => _SalesAnalyticsFormPageState();
}

class _SalesAnalyticsFormPageState extends State<SalesAnalyticsFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create SalesAnalytics' : 'Edit SalesAnalytics'),
        actions: [
          TextButton(
