...
class SalesAnalyticsDetailsPage extends ConsumerWidget {
  final Object id;
  const SalesAnalyticsDetailsPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncData = ref.watch(salesanalyticsGetProvider(id));
