...
class SalesAnalyticsListPage extends ConsumerStatefulWidget {
  const SalesAnalyticsListPage({super.key});

  @override
  ConsumerState<SalesAnalyticsListPage> createState() => _SalesAnalyticsListPageState();
}

class _SalesAnalyticsListPageState extends ConsumerState<SalesAnalyticsListPage> {
  int page = 1;
  int perPage = 10;
  String q = '';
  final selected = <int>{};
  ...
  Widget build(BuildContext context) {
    ...
    final asyncData = ref.watch(salesanalyticsListProvider(params));
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Search Sales Analytics...',
