...
class OrderTrackingDetailsPage extends ConsumerWidget {
  final Object id;
  const OrderTrackingDetailsPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncData = ref.watch(ordertrackingGetProvider(id));
