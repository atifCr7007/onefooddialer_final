...
class OrderTrackingFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const OrderTrackingFormPage({super.key, this.initialData});

  @override
  State<OrderTrackingFormPage> createState() => _OrderTrackingFormPageState();
}

class _OrderTrackingFormPageState extends State<OrderTrackingFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create OrderTracking' : 'Edit OrderTracking'),
        actions: [
          TextButton(
