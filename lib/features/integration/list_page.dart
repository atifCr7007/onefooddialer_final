...
class IntegrationListPage extends ConsumerStatefulWidget {
  const IntegrationListPage({super.key});

  @override
  ConsumerState<IntegrationListPage> createState() => _IntegrationListPageState();
}

class _IntegrationListPageState extends ConsumerState<IntegrationListPage> {
  int page = 1;
  int perPage = 10;
  String q = '';
  final selected = <int>{};
  ...
  Widget build(BuildContext context) {
    ...
    final asyncData = ref.watch(integrationListProvider(params));
