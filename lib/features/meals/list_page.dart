...
class MealsListPage extends ConsumerStatefulWidget {
  const MealsListPage({super.key});

  @override
  ConsumerState<MealsListPage> createState() => _MealsListPageState();
}

class _MealsListPageState extends ConsumerState<MealsListPage> {
  int page = 1;
  int perPage = 10;
  String q = '';
  final selected = <int>{};
  ...
  Widget build(BuildContext context) {
    ...
    final asyncData = ref.watch(mealsListProvider(params));
