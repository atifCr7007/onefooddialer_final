...
class MealsFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const MealsFormPage({super.key, this.initialData});

  @override
  State<MealsFormPage> createState() => _MealsFormPageState();
}

class _MealsFormPageState extends State<MealsFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create Meals' : 'Edit Meals'),
        actions: [
          TextButton(
