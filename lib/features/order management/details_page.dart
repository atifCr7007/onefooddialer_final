...
class OrderManagementDetailsPage extends ConsumerWidget {
  final Object id;
  const OrderManagementDetailsPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncData = ref.watch(ordermanagementGetProvider(id));
