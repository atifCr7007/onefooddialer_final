...
class OrderManagementFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const OrderManagementFormPage({super.key, this.initialData});

  @override
  State<OrderManagementFormPage> createState() => _OrderManagementFormPageState();
}

class _OrderManagementFormPageState extends State<OrderManagementFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create OrderManagement' : 'Edit OrderManagement'),
        actions: [
          TextButton(
