...
class CustomersFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const CustomersFormPage({super.key, this.initialData});

  @override
  State<CustomersFormPage> createState() => _CustomersFormPageState();
}

class _CustomersFormPageState extends State<CustomersFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create Customers' : 'Edit Customers'),
        actions: [
          TextButton(
