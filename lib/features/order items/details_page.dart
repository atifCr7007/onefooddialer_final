...
class OrderItemsDetailsPage extends ConsumerWidget {
  final Object id;
  const OrderItemsDetailsPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncData = ref.watch(orderitemsGetProvider(id));
