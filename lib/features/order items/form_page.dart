...
class OrderItemsFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const OrderItemsFormPage({super.key, this.initialData});

  @override
  State<OrderItemsFormPage> createState() => _OrderItemsFormPageState();
}

class _OrderItemsFormPageState extends State<OrderItemsFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create OrderItems' : 'Edit OrderItems'),
        actions: [
          TextButton(
