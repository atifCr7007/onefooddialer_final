...
class KitchensFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const KitchensFormPage({super.key, this.initialData});

  @override
  State<KitchensFormPage> createState() => _KitchensFormPageState();
}

class _KitchensFormPageState extends State<KitchensFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create Kitchens' : 'Edit Kitchens'),
        actions: [
          TextButton(
