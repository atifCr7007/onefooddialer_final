...
class CustomerAddressesDetailsPage extends ConsumerWidget {
  final Object id;
  const CustomerAddressesDetailsPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncData = ref.watch(customeraddressesGetProvider(id));
