...
class CustomerAddressesListPage extends ConsumerStatefulWidget {
  const CustomerAddressesListPage({super.key});

  @override
  ConsumerState<CustomerAddressesListPage> createState() => _CustomerAddressesListPageState();
}

class _CustomerAddressesListPageState extends ConsumerState<CustomerAddressesListPage> {
  int page = 1;
  int perPage = 10;
  String q = '';
  final selected = <int>{};
  ...
  Widget build(BuildContext context) {
    ...
    final asyncData = ref.watch(customeraddressesListProvider(params));
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Search Customer Addresses...',
