...
class PaymentMethodsFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const PaymentMethodsFormPage({super.key, this.initialData});

  @override
  State<PaymentMethodsFormPage> createState() => _PaymentMethodsFormPageState();
}

class _PaymentMethodsFormPageState extends State<PaymentMethodsFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create PaymentMethods' : 'Edit PaymentMethods'),
        actions: [
          TextButton(
