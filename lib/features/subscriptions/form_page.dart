...
class SubscriptionsFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const SubscriptionsFormPage({super.key, this.initialData});

  @override
  State<SubscriptionsFormPage> createState() => _SubscriptionsFormPageState();
}

class _SubscriptionsFormPageState extends State<SubscriptionsFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create Subscriptions' : 'Edit Subscriptions'),
        actions: [
          TextButton(
