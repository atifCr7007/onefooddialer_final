...
class TimeslotsFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const TimeslotsFormPage({super.key, this.initialData});

  @override
  State<TimeslotsFormPage> createState() => _TimeslotsFormPageState();
}

class _TimeslotsFormPageState extends State<TimeslotsFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create Timeslots' : 'Edit Timeslots'),
        actions: [
          TextButton(
