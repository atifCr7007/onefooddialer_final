...
class CatalogsFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const CatalogsFormPage({super.key, this.initialData});

  @override
  State<CatalogsFormPage> createState() => _CatalogsFormPageState();
}

class _CatalogsFormPageState extends State<CatalogsFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create Catalogs' : 'Edit Catalogs'),
        actions: [
          TextButton(
