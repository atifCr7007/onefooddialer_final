...
class LocationsFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const LocationsFormPage({super.key, this.initialData});

  @override
  State<LocationsFormPage> createState() => _LocationsFormPageState();
}

class _LocationsFormPageState extends State<LocationsFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create Locations' : 'Edit Locations'),
        actions: [
          TextButton(
