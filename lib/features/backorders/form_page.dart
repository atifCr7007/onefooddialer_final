...
class BackordersFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const BackordersFormPage({super.key, this.initialData});

  @override
  State<BackordersFormPage> createState() => _BackordersFormPageState();
}

class _BackordersFormPageState extends State<BackordersFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create Backorders' : 'Edit Backorders'),
        actions: [
          TextButton(
