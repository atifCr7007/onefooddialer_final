...
class CustomerAnalyticsFormPage extends StatefulWidget {
  final Map<String, dynamic>? initialData;
  const CustomerAnalyticsFormPage({super.key, this.initialData});

  @override
  State<CustomerAnalyticsFormPage> createState() => _CustomerAnalyticsFormPageState();
}

class _CustomerAnalyticsFormPageState extends State<CustomerAnalyticsFormPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.initialData == null ? 'Create CustomerAnalytics' : 'Edit CustomerAnalytics'),
        actions: [
          TextButton(
