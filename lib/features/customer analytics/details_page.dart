...
class CustomerAnalyticsDetailsPage extends ConsumerWidget {
  final Object id;
  const CustomerAnalyticsDetailsPage({super.key, required this.id});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncData = ref.watch(customeranalyticsGetProvider(id));
