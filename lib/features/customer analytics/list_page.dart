...
class CustomerAnalyticsListPage extends ConsumerStatefulWidget {
  const CustomerAnalyticsListPage({super.key});

  @override
  ConsumerState<CustomerAnalyticsListPage> createState() => _CustomerAnalyticsListPageState();
}

class _CustomerAnalyticsListPageState extends ConsumerState<CustomerAnalyticsListPage> {
  int page = 1;
  int perPage = 10;
  String q = '';
  final selected = <int>{};
  ...
  Widget build(BuildContext context) {
    ...
    final asyncData = ref.watch(customeranalyticsListProvider(params));
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Search Customer Analytics...',
