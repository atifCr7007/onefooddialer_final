...
class _$Logout200Response extends Logout200Response {
  ...
  ]) => (Logout200ResponseBuilder()..update(updates))._build();

  _$Logout200Response._({this.status, this.message}) : super._();
  @override
  ...
  Logout200ResponseBuilder toBuilder() =>
      Logout200ResponseBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is Logout200Response &&
        status == other.status &&
...
class Logout200ResponseBuilder
  ...
  _$Logout200Response _build() {
    final _$result =
        _$v ?? _$Logout200Response._(status: status, message: message);
    replace(_$result);
    return _$result;
  }
}
