...
class StatisticsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [InvoicesStatisticsGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InvoicesStatisticsGet200Response>> invoicesStatisticsGet({ 
    int? companyId,
    Date? dateFrom,
    Date? dateTo,
    ...
    final _path = r'/invoices/statistics';
    ...
    InvoicesStatisticsGet200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(InvoicesStatisticsGet200Response),
      ) as InvoicesStatisticsGet200Response;
    ...
    return Response<InvoicesStatisticsGet200Response>(
      data: _responseData,
