...
// tests for MealInput
void main() {
  final instance = MealInputBuilder();
  ...
  group(MealInput, () {
    ...
    // String foodType
    test('to test the property `foodType`', () async {
      // TODO
    });
    ...
    // bool isSwappable
    test('to test the property `isSwappable`', () async {
      // TODO
    });

    // Meals that can be swapped with this meal
    // String swapWith
    test('to test the property `swapWith`', () async {
      // TODO
    });
    ...
    // String mealPlans
    test('to test the property `mealPlans`', () async {
      // TODO
    });
