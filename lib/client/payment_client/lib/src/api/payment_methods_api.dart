...
class PaymentMethodsApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeleteResponse>> deletePaymentMethod({ 
    required int id,
    int? customerId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/payment-methods/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [activeOnly] - Whether to return only active payment methods
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaymentMethodsResponse>> getCustomerPaymentMethods({ 
    ...
    final _path = r'/payment-methods/customer/{customerId}'.replaceAll('{' r'customerId' '}', encodeQueryParameter(_serializers, customerId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [PaymentMethodResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaymentMethodResponse>> getPaymentMethod({ 
    required int id,
    int? customerId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [PaymentMethodResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaymentMethodResponse>> setDefaultPaymentMethod({ 
    required int id,
    int? customerId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/payment-methods/{id}/default'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
