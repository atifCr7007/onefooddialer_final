...
class _$PaymentMethodResponse extends PaymentMethodResponse {
  ...
  _$PaymentMethodResponse._({this.success, this.message, this.data})
    : super._();
  @override
...
class PaymentMethodResponseBuilder
  ...
  PaymentMethodBuilder? _data;
  PaymentMethodBuilder get data => _$this._data ??= PaymentMethodBuilder();
  set data(PaymentMethodBuilder? data) => _$this._data = data;
