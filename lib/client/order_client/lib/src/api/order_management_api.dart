...
class OrderManagementApi {
  ...
  const OrderManagementApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [OrdersResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Response>> ordersGet({ 
    int? page = 1,
    int? limit = 20,
    String? search,
    String? status,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (restaurantId != null) r'restaurantId': encodeQueryParameter(_serializers, restaurantId, const FullType(String)),
      if (paymentStatus != null) r'paymentStatus': encodeQueryParameter(_serializers, paymentStatus, const FullType(String)),
      if (deliveryType != null) r'deliveryType': encodeQueryParameter(_serializers, deliveryType, const FullType(String)),
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> ordersOrderIdDelete({ 
    required String orderId,
    required OrdersOrderIdDeleteRequest ordersOrderIdDeleteRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(OrdersOrderIdDeleteRequest);
      _bodyData = _serializers.serialize(ordersOrderIdDeleteRequest, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Order>> ordersOrderIdGet({ 
    required String orderId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [Order] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Order>> ordersOrderIdPut({ 
    required String orderId,
  ...
  /// Returns a [Future] containing a [Response] with a [Order] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Order>> ordersPost({ 
    required RequestOptions body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
