...
/// * [unitId] 
@BuiltValue()
abstract class AddressUpdate implements Built<AddressUpdate, AddressUpdateBuilder> {
  ...
  factory AddressUpdate([void updates(AddressUpdateBuilder b)]) = _$AddressUpdate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AddressUpdateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AddressUpdate> get serializer => _$AddressUpdateSerializer();
}
