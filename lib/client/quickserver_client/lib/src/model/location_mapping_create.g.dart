...
part of 'location_mapping_create.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$LocationMappingCreate extends LocationMappingCreate {
  @override
  final int? companyId;
  @override
  final int? unitId;
  ...
  LocationMappingCreateBuilder toBuilder() =>
      LocationMappingCreateBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is LocationMappingCreate &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'LocationMappingCreate')
...
class LocationMappingCreateBuilder
    implements Builder<LocationMappingCreate, LocationMappingCreateBuilder> {
  _$LocationMappingCreate? _$v;
  ...
  LocationMappingCreateBuilder() {
    LocationMappingCreate._defaults(this);
  }

  LocationMappingCreateBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(LocationMappingCreate other) {
    _$v = other as _$LocationMappingCreate;
  }

  @override
  void update(void Function(LocationMappingCreateBuilder)? updates) {
