...
part 'location_mapping_update.g.dart';
...
/// * [status] 
@BuiltValue()
abstract class LocationMappingUpdate implements Built<LocationMappingUpdate, LocationMappingUpdateBuilder> {
  ...
  LocationMappingUpdate._();

  factory LocationMappingUpdate([void updates(LocationMappingUpdateBuilder b)]) = _$LocationMappingUpdate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LocationMappingUpdateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LocationMappingUpdate> get serializer => _$LocationMappingUpdateSerializer();
}

class _$LocationMappingUpdateSerializer implements PrimitiveSerializer<LocationMappingUpdate> {
  @override
  final Iterable<Type> types = const [LocationMappingUpdate, _$LocationMappingUpdate];

  @override
  final String wireName = r'LocationMappingUpdate';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LocationMappingUpdate object, {
  ...
  void _deserializeProperties(
    ...
    required LocationMappingUpdateBuilder result,
  ...
  @override
  LocationMappingUpdate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LocationMappingUpdateBuilder();
