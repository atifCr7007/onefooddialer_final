...
class IntegrationApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [EstimateDeliveryTime200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EstimateDeliveryTime200Response>> estimateDeliveryTime({ 
    ...
    final _path = r'/integration/delivery/orders/{orderId}/estimate-delivery-time'.replaceAll('{' r'orderId' '}', encodeQueryParameter(_serializers, orderId, const FullType(String)).toString());
    ...
    EstimateDeliveryTime200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(EstimateDeliveryTime200Response),
      ) as EstimateDeliveryTime200Response;
    ...
    return Response<EstimateDeliveryTime200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetOrderPreparationStatus200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetOrderPreparationStatus200Response>> getOrderPreparationStatus({ 
    required String orderId,
    Date? date,
    String? menu,
    CancelToken? cancelToken,
    ...
    final _path = r'/integration/orders/{orderId}/preparation-status'.replaceAll('{' r'orderId' '}', encodeQueryParameter(_serializers, orderId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetOrderPreparationStatus200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetOrderPreparationStatus200Response),
      ) as GetOrderPreparationStatus200Response;
    ...
    return Response<GetOrderPreparationStatus200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [GetOrderPreparationStatusForDelivery200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetOrderPreparationStatusForDelivery200Response>> getOrderPreparationStatusForDelivery({ 
    required String orderId,
    Date? date,
    String? menu,
    CancelToken? cancelToken,
    ...
    final _path = r'/integration/delivery/orders/{orderId}/preparation-status'.replaceAll('{' r'orderId' '}', encodeQueryParameter(_serializers, orderId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetPreparationStatus200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetPreparationStatus200Response>> getPreparationStatus({ 
    required BuiltList<int> productIds,
    int? kitchenId,
    Date? date,
    String? menu,
    CancelToken? cancelToken,
    ...
    final _path = r'/integration/preparation-status';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      r'product_ids': encodeCollectionQueryParameter<int>(_serializers, productIds, const FullType(BuiltList, [FullType(int)]), format: ListFormat.multi,),
      if (kitchenId != null) r'kitchen_id': encodeQueryParameter(_serializers, kitchenId, const FullType(int)),
      if (date != null) r'date': encodeQueryParameter(_serializers, date, const FullType(Date)),
      if (menu != null) r'menu': encodeQueryParameter(_serializers, menu, const FullType(String)),
    };
    ...
    GetPreparationStatus200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetPreparationStatus200Response),
      ) as GetPreparationStatus200Response;
    ...
    return Response<GetPreparationStatus200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetPreparationSummary200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetPreparationSummary200Response>> getPreparationSummary({ 
    int? kitchenId,
    Date? date,
    String? menu,
    CancelToken? cancelToken,
    ...
    final _path = r'/integration/preparation-summary';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetPreparationSummary200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetPreparationSummary200Response),
      ) as GetPreparationSummary200Response;
    ...
    return Response<GetPreparationSummary200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [NotifyDeliveryStatusUpdate200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotifyDeliveryStatusUpdate200Response>> notifyDeliveryStatusUpdate({ 
    required NotifyDeliveryStatusUpdateRequest notifyDeliveryStatusUpdateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/integration/delivery/status-update';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(NotifyDeliveryStatusUpdateRequest);
      _bodyData = _serializers.serialize(notifyDeliveryStatusUpdateRequest, specifiedType: _type);
    ...
    NotifyDeliveryStatusUpdate200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(NotifyDeliveryStatusUpdate200Response),
      ) as NotifyDeliveryStatusUpdate200Response;
    ...
    return Response<NotifyDeliveryStatusUpdate200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
