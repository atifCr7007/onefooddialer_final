...
class OrdersApi {
  ...
  ///
  /// Parameters:
  /// * [locationId] - Filter orders by location ID
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetDeliveryOrders200Response] as data
  ...
  Future<Response<GetDeliveryOrders200Response>> getDeliveryOrders({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (locationId != null) r'location_id': encodeQueryParameter(_serializers, locationId, const FullType(int)),
    ...
    GetDeliveryOrders200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetDeliveryOrders200Response),
      ) as GetDeliveryOrders200Response;
    ...
    return Response<GetDeliveryOrders200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateDeliveryStatus200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UpdateDeliveryStatus200Response>> updateDeliveryStatus({ 
    ...
    final _path = r'/orders/{orderId}/delivery-status'.replaceAll('{' r'orderId' '}', encodeQueryParameter(_serializers, orderId, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UpdateDeliveryStatusRequest);
      _bodyData = _serializers.serialize(updateDeliveryStatusRequest, specifiedType: _type);
    ...
    UpdateDeliveryStatus200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UpdateDeliveryStatus200Response),
      ) as UpdateDeliveryStatus200Response;
    ...
    return Response<UpdateDeliveryStatus200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
