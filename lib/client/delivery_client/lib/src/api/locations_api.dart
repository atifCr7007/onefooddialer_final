...
class LocationsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [GetDeliveryLocations200Response] as data
  ...
  Future<Response<GetDeliveryLocations200Response>> getDeliveryLocations({ 
    ...
    GetDeliveryLocations200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetDeliveryLocations200Response),
      ) as GetDeliveryLocations200Response;
    ...
    return Response<GetDeliveryLocations200Response>(
      data: _responseData,
